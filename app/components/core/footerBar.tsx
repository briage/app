    ...
    return (
        <View style={styles.fixed}>
            <View style={styles.navItem} onTouchEnd={() => {history.push('/')}}>
                ...
                <Text style={{color: location.pathname === '/' ? '#38f' : '#000', fontSize: 11}}>首页</Text>
            </View>
            <View style={styles.navItem} onTouchEnd={() => {history.push('/testpaper')}}>
                ...
                <Text style={{color: location.pathname === '/testpaper' ? '#38f' : '#000', fontSize: 11}}>练习</Text>
            </View>
            <View style={styles.navItem} onTouchEnd={() => {history.push('/table')}}>
                <Icon name='appstore-o' size={20} color={location.pathname === '/table' ? '#38f' : '#000'} />
                <Text style={{color: location.pathname === '/table' ? '#38f' : '#000', fontSize: 11}} >课程表</Text>
            </View>
            <View style={styles.navItem} onTouchEnd={() => {history.push('/myInfo')}}>
                <Icon name='user' size={20} color={location.pathname === '/myInfo' ? '#38f' : '#000'} />
                <Text style={{color: location.pathname === '/myInfo' ? '#38f' : '#000', fontSize: 11}}>我的</Text>
            </View>
        </View>
    )
}
